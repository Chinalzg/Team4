...
<div id="header_top">
  <div id="top">
	...
	<div class="hd_top_manu clearfix">
	  <ul class="clearfix">
	   <li class="hd_menu_tit zhuce" data-addclass="hd_menu_hover">欢迎光临本店！<a href="#" class="red">[请登录]</a> 新用户
	   <a href="#" class="red">[免费注册]</a></li>
	   <li class="hd_menu_tit" data-addclass="hd_menu_hover"><a href="#">我的订单</a></li> 
	   <li class="hd_menu_tit" data-addclass="hd_menu_hover"> <a href="shopcart">购物车(<b>0</b>)</a> </li>
       ...
       <li class="hd_menu_tit phone_c" data-addclass="hd_menu_hover"><a href="#" class="hd_menu ">
       <em class="iconfont icon-phone"></em>手机版</a>
...
<div id="header "  class="header page_style">
  ...
  <div class="Search">
	...
	<p class="Words"><a href="#">苹果</a><a href="#">香蕉</a><a href="#">菠萝</a><a href="#">西红柿</a><a href="#">橙子</a>
	<a href="#">苹果</a></p>
</div>
<!--可修改图层2-->
 ...
 <div class="hd_Shopping_list" id="Shopping_list">
   <div class="s_cart"><em></em><a href="shopcart">我的购物车</a> <i class="ci-right">&gt;</i>
   ...
   <div class="dorpdown-layer">
    <div class="spacer"></div>
	 ...
	 <div class="p-total">共<b>1</b>件商品　共计<strong>￥ 515.00</strong></div>
	  <a href="shopcart" title="去购物车结算" id="btn-payforgoods" class="Shopping">去购物车结算</a>
	 </div>	 
   </div>
 </div>
</div>
  ...
  <!--收藏-->
   ...
   <!--信息样式-->
    ...
    <form action="javascript:addToCart(97)" name="ECS_FORMBUY" id="ECS_FORMBUY">
	  ...
	  <div class="margins">
	  <div class="Price clearfix"><label>价格</label><span>¥10.9 <b>34.00</b></span></div>
	  <div class="Activity clearfix"><label>活动</label><span>指定商品满¥50，可换购以下任一商品</span></div>
        ...
        <div class="item"><b></b><a href="#none" title="小礼盒">小礼盒</a></div> 
        <div class="item  selected"><b></b><a href="#none" title="普通包装">普通包装</a></div>
