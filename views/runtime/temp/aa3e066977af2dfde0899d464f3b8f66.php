<?php /*a:1:{s:78:"D:\phpStudy\PHPTutorial\WWW\views\application\admin\view\comm\detail_comm.html";i:1558271889;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="gray-bg">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" action="javascript:;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div id="div1" disabled class="" style="width: 100%;height: auto;" cols="30" rows="10"><?php echo $data['comm_content_normal']; ?></div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    <input type="hidden" name="comm_id" value="<?php echo htmlentities($data['comm_id']); ?>">
    ...
    <script>
        ...
        $(".blogCheck").on('click',function () {
            var commStatus = $(this).attr('data-status');
            var comm_id = $("input[name='comm_id']").val();

            $.post("/admin/Comm/detailComm",{"commStatus":commStatus,"comm_id":comm_id},function(jsonMsg){
