<?php /*a:2:{s:77:"D:\phpStudy\PHPTutorial\WWW\views\application\index\view\user\write_blog.html";i:1558271889;s:38:"./static/common/html/index_header.html";i:1559650103;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" action="/index/User/writeBlog" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-1 control-label">博文标题：</label>
                                <div class="col-sm-8">
                                    <input type="text" placeholder="标题" class="form-control" name="article_title">
                            ...
                            <div class="form-group">
                                ...
                                <div id="div1"></div>
                                <textarea id="editor" hidden name="article_content"></textarea>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-8">
                            ...
                            <input type="hidden" name="article_user_id" value="<?php echo htmlentities($user_id); ?>">
                        </form>
                    </div>
                </div>
            </div>
