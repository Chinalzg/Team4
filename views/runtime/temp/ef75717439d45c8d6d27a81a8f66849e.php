<?php /*a:2:{s:76:"D:\phpStudy\PHPTutorial\WWW\views\application\index\view\link\show_link.html";i:1559650032;s:38:"./static/common/html/index_header.html";i:1559650103;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="pageside">
    <div class="pagemenus">
      <ul class="pagemenu">
        ...
        <li><a href="/index/Link/showLink">友情链接</a></li>
      </ul>
    </div>
  </div>
  <div class="content">
    ...
    <ul class="plinks">
      <?php foreach($linkData as $k => $v): ?>
        <li>
          <a href="<?php echo htmlentities($v['link_link']); ?>" title="" target="_blank" rel="nofollow"><img src="/static/admin/uploads/link/<?php echo htmlentities($v['link_img']); ?>" alt="">
