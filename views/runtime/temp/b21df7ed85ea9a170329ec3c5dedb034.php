<?php /*a:3:{s:80:"D:\phpStudy\PHPTutorial\WWW\views\application\index\view\user\update_myself.html";i:1558597317;s:38:"./static/common/html/index_header.html";i:1559216585;s:43:"./static/common/html/right_person_info.html";i:1558663101;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<section class="container">
  <div class="content-wrap">
    <div class="content excerpt excerpt-1" style="padding: 15px 15px 11px 0px;">
              ...
              <div class="ibox-content">
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" placeholder="请输入您的新昵称..." class="form-control" name="user_name" required value="<?php echo htmlentities($thisUser['user_name']); ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label">昵称：</label>
                    <div class="col-sm-8">
                      <input type="text" placeholder="请输入您的新昵称..." class="form-control" name="user_name" required value="<?php echo htmlentities($thisUser['user_phone']); ?>" disabled>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label">邮箱：</label>
                    <div class="col-sm-8" style="margin-top: 5px;">
                      <input type="text"  class="form-control" style="" required value="<?php echo htmlentities($thisUser['user_email']); ?>" name="user_email" placeholder="请输入您的新邮箱地址...">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label">账号状态：</label>
                    <div class="col-sm-8" style="margin-top: 7px;">
                      <?php if($thisUser['user_status'] == 2): ?>
                        <span style="color: green;font-weight: bold;">正常</span>
                      <?php elseif($thisUser['user_status'] == 3): ?>
                        <span style="color: red;font-weight: bold;">封号</span>
                      <?php endif; ?>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-8" style="margin-top: 5px;">
                      <input type="text"  class="form-control" style="" required value="<?php echo htmlentities(date('Y-m-d',!is_numeric($thisUser['user_addtime'])? strtotime($thisUser['user_addtime']) : $thisUser['user_addtime'])); ?>" disabled>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label">上传头像：</label>
                    <div class="col-sm-8">
                      <input type="file" placeholder="请选择图片..." class="form-control" name="user_headimg" style="padding: 0;height: 35px;" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-8">
                      <input type="hidden" name="user_id" value="<?php echo htmlentities($thisUser['user_id']); ?>">
                      <button class="btn btn-sm btn-info" type="submit">提交 修改</button>
                    </div>
                  </div>
                </form>
              </div>
