<?php /*a:1:{s:76:"D:\phpStudy\PHPTutorial\WWW\views\application\admin\view\cate\show_cate.html";i:1558271888;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <tbody>
                            <?php foreach($data as $k => $v): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($v['cate_addtime'])? strtotime($v['cate_addtime']) : $v['cate_addtime'])); ?></td>
                                    <td>
                                        <a href="">删除</a>
                                    </td>
                                </tr>
