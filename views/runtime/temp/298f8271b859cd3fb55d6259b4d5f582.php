<?php /*a:3:{s:77:"D:\phpStudy\PHPTutorial\WWW\views\application\index\view\user\user_blogs.html";i:1558597367;s:38:"./static/common/html/index_header.html";i:1559650103;s:43:"./static/common/html/right_person_info.html";i:1558663101;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="content-wrap">
    <div class="content">
      ...
      <article class="excerpt excerpt-1">
        ...
        <p class="note"><?php echo $v['short_article_content']; ?></p>
        <ul  style="margin-top: 27px;">
          <li style="float: right;width: 33px;text-align: center;">
            <a href="/index/User/updateBlog?article_id=<?php echo htmlentities($v['article_id']); ?>" class="note">编辑</a>
          </li>
          <li style="float: right;width: 33px;text-align: center;">
            <a href="/index/User/deleteBlog?article_id=<?php echo htmlentities($v['article_id']); ?>" class="note">删除</a>
          </li>
        </ul>
      </article>
      <?php endforeach; ?>
