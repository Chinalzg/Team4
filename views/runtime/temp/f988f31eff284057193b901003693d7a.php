<?php /*a:3:{s:74:"D:\phpStudy\PHPTutorial\WWW\views\application\index\view\user\comm_me.html";i:1558662982;s:38:"./static/common/html/index_header.html";i:1559216585;s:43:"./static/common/html/right_person_info.html";i:1558663101;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
    ...
    <div class="content excerpt excerpt-1" style="padding: 15px 15px 11px 0px;">
      ...
      <div class="container">
        <table class="table table-striped" style="width: 100%;">
          ...
          <tbody>
            <?php foreach($commMeData as $k => $v): ?>
              <tr>
                <td><?php echo htmlentities($v['article_title']); ?></td>
                <td><?php echo $v['comm_content_short']; ?></td>
                ...
                <td>
                  <a href="/index/Article/showArticle?article_id=<?php echo htmlentities($v['article_id']); ?>">查看此文章</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
